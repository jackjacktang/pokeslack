...
# modified by me
high_priority_list = [1,2,3,4,5,6,7,8,9,25,26,38,40,51,57,59,64,65,67,68,75,76,87,89,93,94,97,105,107,110,115,122,124,125,128,130,131,132,137,141,142,143,147,148,149]
...
def main():
    ...
    pokemonsJSON = json.load(
        ...
        # codecs.open(path + '/locales/pokemon.zh_cn.json', "r", 'UTF-8'))
            ...
            for cell in hh.cells:
                for wild in cell.WildPokemon:
                    ...
                    if hash not in seen.keys() or (seen[hash].TimeTillHiddenMs <= wild.TimeTillHiddenMs):
                        #modified by me
                        if wild.pokemon.PokemonId in high_priority_list:
                        	visible.append(wild)
